...
DRONE.API = (function() {
  ...
  function sendCommands(commands) {
    ...
    // output the commands
    //console.log(commands.join("")+"   "+JSON.stringify(status) + "\n\n" + JSON.stringify(DRONE.NavData.getData().options, null, " "));
    ...
    // for whatever reason send the other COMMANDS_ENABLED
    readNavData();
